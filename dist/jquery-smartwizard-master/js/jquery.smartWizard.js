  ...
  var SmartWizard = /*#__PURE__*/function () {
    ...
    _createClass(SmartWizard, [{
      ...
      value: function _getStepPage(idx) {
        ...
        return anchor.length > 0 ? this.main.find(anchor.attr("data-target")) : null;
      }
    }, {
      key: "_setStepContent",
      ...
      value: function _transitStep(idx) {
        ...
        this._setURLHash(selStep.attr("data-target")); // Update controls
      ...
      value: function _getURLHashIndex() {
        if (this.options.enableURLhash) {
          ...
          if (hash.length > 0) {
            var elm = this.nav.find("a[data-target*='" + hash + "']");
