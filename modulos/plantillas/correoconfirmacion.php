										...
										<tr>
											...
											<div style="background-color:#f5f5f5;direction:ltr;padding:22px 16px;margin-bottom:3px">
												<table class="m_6542478942723271434v2rsp" width="100%" border="0" cellspacing="0" cellpadding="0">
													<tbody>
														<tr>
															<td><span style="font-family:Roboto-Regular,Helvetica,Arial,sans-serif;font-size:13px;color:rgba(0,0,0,0.87);line-height:1.6;color:rgba(0,0,0,0.54);">%detalle%</span></td>
														</tr>
													</tbody>
												</table>
											</div>
